...
```{r best_model}
# model_values = (3, 5, 7, 9, 11); the best is 9.
...
### PSNR for 1500 training images
```{r}
source("../lib/superResolution.R")
train_HR_pred_dir <- "../output/HR_pred/"
train.time <- system.time(superResolution(train_LR_dir, train_HR_pred_dir, fit_train))
train.time[3]

source("../lib/PSNR.R")
baseline.result <- a.psnr(train_HR_dir, train_HR_pred_dir)
# Average PSNR for 1500 training images
